...
let res = await fetch('https://api.github.com/repos/David-OFC/The-SimpleBot-MD')
...
await conn.sendUrl(m.chat, git, m, { externalAdReply: { mediaType: 1, renderLargerThumbnail: true, thumbnail: imagen2, thumbnailUrl: imagen1, title: '\t\t\t\t\t\t᭡͡ᩬ✩̣̣̣̣̣ͯ𝑻𝒉𝒆-𝑺𝒊𝒎𝒑𝒍𝒆𝑩𝒐𝒕-𝑴𝑫᭡͡ᩬ✩̣̣̣̣̣ͯ', }})
